                ...
                <tr>
                    <td style="padding: 30px 20px 20px 20px; mso-padding-alt: 30px 20px 20px 20px; text-align: {{ $email_alignment }};">
                        <div id="content">
                                ...
                                {{ $slot ?? '' }}
                                {!! $body ?? '' !!}
                                {{-- Módulo Albaranes: se retira el botón "Ver" vacío (el albarán va en
                                     el PDF adjunto) y la lista de enlaces sólo se pinta si hay enlaces,
                                     para no dejar un hueco en blanco bajo el cuerpo. --}}
